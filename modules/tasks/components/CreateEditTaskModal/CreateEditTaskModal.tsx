import { FolderOpenIcon, HashtagIcon, PencilIcon, PlusIcon, UserCircleIcon } from "@heroicons/react/24/outline";
import {
  Button,
  Col,
  Collapse,
...
const CreateEditTaskModal = (props: Props) => {
  ...
  const assignees: BaseOptionType[] = participantList.map((item) => ({
    ...
    label:
      <Flex gap={8}>
        <img src={item.profileInfo.avatar} style={{ width: '25px', height: '25px', borderRadius: '50%' }}></img>
              ...
              <Row align="middle">
                ...
                <Col xs={15}>
                  <Form.Item<FormType> name={["timing", "startDate"]}>
                    <DatePicker variant="borderless" placeholder="Start from" style={{ width: '100%' }} />
                  </Form.Item>
                </Col>
              </Row>
            </div>
              ...
              <Row align="middle">
                ...
                <Col xs={15}>
                  <Form.Item<FormType> name={["timing", "endDate"]}>
                    <DatePicker variant="borderless" placeholder="Due to" style={{ width: '100%' }} />
                  </Form.Item>
                </Col>
              </Row>
            </div>
